/* get the readline function of command line to interect with the user */
...
*@function
*@name confirm 
*@description This functoin expects message and prompts the user for a yes/no input. If there is no error, then go to [get] function to ask and verify question
*@param {string} message - message showed to the user
...
*@function
*@name get
*@description This function asks, prompts for input, verifies question and continues/ends the communication
*@param {object} options - object contains three strings
*@param {string} options.reply.type - the type of the message
*@param {string} options.reply.message - the message content
*@param {string} options.reply.default - the default answer of the message
*@param {function} callback
*/
var get = exports.get = function(options, callback) {
  ...
  var answers = {},
      stdin = process.stdin, //what is it?
  ...
  //loop through the key and check the answer
  ...
  //if answer right, loop to next question,
  //if not, end the interface
